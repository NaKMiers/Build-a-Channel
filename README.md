...
- [.agents/skills](C:\ME\THINGS\Build a Channel\.agents\skills)
  Executable project-local skills. Current skills include `browse`, `topic-intake`, `research-pack`, `script-draft`, `packaging`, `voiceover`, `visual-plan`, `render`, `auto-adjust`, and `wiw-take-note`; the remaining sequential video production skills will be created later.
