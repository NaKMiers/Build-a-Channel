...
- [WIT Channel System](../docs/branding/wit-channel-system.md)
...
Use this workflow only when starting or updating a future video with explicit permission to work inside its `video-projects/<slug>/` folder.
...
common/assets/ui-mockups/
```

Use `common/assets/real-life/` for reusable object photos, paper textures, cutouts, and physical environments.

Use `common/assets/ui-mockups/` for reusable fake app screens, browser windows, feed cards, comments, payment screens, and notification systems.

Use `common/assets/source-note-template.md` as the source note template for both folders.

Do not store one-off video assets in `common/`.
...
common/assets/real-life/
common/assets/ui-mockups/
common/assets/source-note-template.md
```

No existing `video-projects/` files are updated by this system.
