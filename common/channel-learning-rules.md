...
Use these categories in `docs/learning-log.md`:
...
- move a useful asset into `common/`
...
| --- | --- | --- |
| One-video note | future `video-projects/<slug>/` review | Do not promote unless reusable |
| Reusable workflow lesson | `docs/learning-log.md` | Label as `Operational lesson` |
| Reusable packaging lesson | `docs/learning-log.md` | Label as `Packaging lesson` |
| Reusable audience pattern | `docs/learning-log.md` | Label as `Audience insight` |
| Unproven but useful test | `docs/learning-log.md` | Label as `Experiment result` or experiment |
...
Do not update `docs/channel-foundation.md` from upload feedback unless:

- the lesson is repeated
- the change fits `Why It Works`
- the change passes `docs/channel-guardrails.md`
