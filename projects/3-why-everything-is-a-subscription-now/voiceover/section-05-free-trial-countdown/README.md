...
Note: this section's hand-tuned pacing is the APPROVED gold-standard template the whole video follows.
...
- File: `scratch-audio/section-05-free-trial-countdown-david23-am_eric-0.8.mp3`
- Duration: `53.867s` (section estimate `2:59-3:58`)
