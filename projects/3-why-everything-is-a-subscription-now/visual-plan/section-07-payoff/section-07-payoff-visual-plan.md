# Section 7 Visual Plan (Section 1 standing template, 2026-06-23)

Video: `Why Everything Is a Subscription Now`
Section: `Section 7: Payoff: The Product Is You Not Cancelling` (final section)
Status: `built + previewing on localhost:1007`

## Source Inputs

- Voiceover: `voiceover/section-07-payoff/scratch-audio/section-07-payoff-david23-am_eric-0.8.mp3`
- Duration: `54.101s` (TTS). Word timings GENERATED this run (whisper-tiny.en); clean; capped at 54.101.
...
|---|---:|---|---|---|---|
| BS1 reveal / forgetting | 0.0–13.0 | "most valuable thing… your forgetting" | dollar spread | what they really sell is your forgetting | base-cash.jpg |
| BS2 the product is YOU | 13.0–18.6 | "the product was never the thing… the product is you" | phone | the device's real product is you, staying | base-phone.jpg |
| BS3 some worth it / a design | 18.6–27.4 | "aren't evil… some worth it… a design not an accident" | coin jar | the fair caveat | base-coins.jpg |
| BS4 cancel the ghosts | 27.4–39.4 | "turn the phone against them… keep what you love… cancel the ghosts" | $1 close-up | audit your money, cancel the ghosts | base-cash2.jpg |
| BS5 your salary, for now | 39.4–54.101 | "remembering what you pay for… your salary. for now." | phone, bank-app | the one screen not asking for money | base-phone-2.jpg |
...
|---|---|---|---|
| base-cash.jpg | real CC0 | safe asset; StockSnap (Openverse) "Bills Cash" dollar spread | BS1 |
| base-phone.jpg / base-phone-2.jpg | real CC0 | safe asset; rawpixel (Openverse) phone on wood (2nd filename = the bank-app final, non-adjacent) | BS2, BS5 |
| base-coins.jpg | real CC0 | safe asset; rawpixel (Openverse) coin jar | BS3 |
| base-cash2.jpg | real CC0 | safe asset; StockSnap (Openverse) "$1" close-up (distinct from base-cash) | BS4 |
| crossed chips / FORGETTING / barcode tag / statement / bank-app / payoff | self-made CSS | build in render | the idea-devices |
| WIT poses | local PNG | shared manifest | emotion |

Rejected: a person-with-head phone shot, a Mastercard-logo cash shot, a finance flat-lay too similar to S5's piggy flat-lay, PNG sticker illustrations. See `reference-board.md`.

## HyperFrames Guidance

- Composition `Section07Payoff`, 1920x1080, 54.101s, port 1007.
- Scenes on tracks 1/3/4/5/6 (cross-fades at 13.0/18.6/27.4/39.4); cues on track 2 (cue-c trimmed to 8.78 to avoid the 27.4 float overlap).
- The phone reuse (S2/S5) is non-adjacent with distinct CSS; S5 is the script's literal final image (the bank-app salary screen). 2nd filename keeps lint clean.
- Final-frame collision check: the `your salary (for now)` payoff is centered, clear of the right-side WIT and the left bank-app card (verified @53.2s).
- No emoji glyphs; arrows/checks are text/CSS. Smashed elements use explicit left/top.
- Snapshot QA: 5 / 11.5 / 17 / 22 / 25.5 / 33.5 / 38 / 43 / 48 / 53.2.

## Review-Prevention Checklist

- voice sync pinned to generated word starts: yes
- vivid object bases; 2 distinct money shots + the phone reused only non-adjacently for the literal final image: yes
- varied idea-devices, not repeated cream boxes: yes
- giant WIT, varied side/pose (R/L/R/R), 4 beats, S3 breathes: yes
- the statement markup is meaningful (keep row green, ghost rows struck); the barcode names "the product: you": yes
- final payoff clear of WIT + bank-app: yes
- emotionally satisfying close (control → the salary screen → dry "for now"): yes
