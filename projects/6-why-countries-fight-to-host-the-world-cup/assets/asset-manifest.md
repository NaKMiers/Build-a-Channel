...
| ---- | -------------------------------------------- | ------------------- | ------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- | ------------------------------------ |
| [x]  | `trophy-gold-parody.png`                     | generate            | 1.1, 1.2, 1.3, 1.5, 1.6 (+ later sections) | VIDEO HERO: parody golden trophy (gold globe on fluted cup, dark plinth), isolated, transparent                                                                          | Prompt G1 below                                                             | `done` |
| [x]  | `receipt-endless-roll.png`                   | generate            | 1.3, 1.6, 1.7 (+ later sections)           | VIDEO MOTIF: long white receipt strip, faint unreadable print, one curl, transparent                                                                                     | Prompt G2 below                                                             | `done` |
| [x]  | `wit-fan-flag-cheer.png`                     | generate (NEW pose) | 1.1                                        | WIT as euphoric fan: teal scarf + small plain teal pennant, huge cheer                                                                                                   | Prompt G3 below (attach `_origin_.png`)                                     | `done` |
| [x]  | `wit-fan-frozen-mid-cheer.png`               | generate (NEW pose) | 1.3                                        | same fan kit + pose, face flipped to blank dread + sweat drop                                                                                                            | Prompt G4 below (attach `_origin_.png` + finished `wit-fan-flag-cheer.png`) | `done` |
| [x]  | `poses/skeptical_side_eye_doubtful.png`      | pose                | 1.2                                        | library pose copy                                                                                                                                                        | `.agents/_shared/assets/wit/poses/`                                         | `done`                               |
| [x]  | `poses/pondering_skeptical_hand_on_chin.png` | pose                | 1.4                                        | library pose copy                                                                                                                                                        | same                                                                        | `done`                               |
| [x]  | `poses/deadpan_unimpressed_half_lidded.png`  | pose                | 1.5                                        | library pose copy                                                                                                                                                        | same                                                                        | `done`                               |
| [x]  | `poses/hand_on_cheek_surprised_curious.png`  | pose                | 1.6                                        | library pose copy                                                                                                                                                        | same                                                                        | `done`                               |
| [x]  | `poses/pointing_up_curious_open_mouth.png`   | pose                | 1.7                                        | library pose copy                                                                                                                                                        | same                                                                        | `done`                               |
| [x]  | `poses/_origin_.png`                         | pose (reference)    | generation handoff only                    | canonical neutral identity - attach when generating G3/G4                                                                                                                | same                                                                        | `done`                               |
| [x]  | `stadium-fireworks-1.jpg`                    | browse-real-photo   | 1.1                                        | giant multicolor festival firework over a glittering night town (celebration-night base; trophy+confetti+WINNER carry the "won the Cup" meaning)                         | see ATTRIBUTION.md (CC BY 4.0)                                              | `done`                               |
| [x]  | `podium-spotlight-1.jpg`                     | browse-real-photo   | 1.2                                        | single spotlight beam cutting through darkness; trophy sits at the beam's landing                                                                                        | see ATTRIBUTION.md (CC BY 2.0)                                              | `done`                               |
| [x]  | `world-map-vintage-1.jpg`                    | browse-real-photo   | 1.3                                        | 1550s parchment mappemonde (Jomard/Henri II); vertical fold seam near center - crop right-of-seam or hide seam behind the trophy podium                                  | see ATTRIBUTION.md (PD)                                                     | `done`                               |
| [x]  | `ledger-red-pen-1.jpg`                       | browse-real-photo   | 1.4                                        | blank aged ledger page, red center rule, alphabet index tabs (no pen/figures in photo - the handwritten verdict + CSS red marks carry the scene; filename kept per plan) | see ATTRIBUTION.md (PD)                                                     | `done`                               |
| [x]  | `desk-darkwood-1.jpg`                        | browse-real-photo   | 1.5                                        | dark wood planks with moody spotlight vignette (960w preview - swap if soft at 1920)                                                                                     | see ATTRIBUTION.md (CC0)                                                    | `done`                               |
| [x]  | `gold-bokeh-black-1.jpg`                     | browse-real-photo   | 1.6                                        | warm gold string-light bokeh on dark, luxury feel (960w - bokeh upscales safely)                                                                                         | see ATTRIBUTION.md (CC0)                                                    | `done`                               |
| [x]  | `curtain-dark-1.jpg`                         | browse-real-photo   | 1.7                                        | dark red stage curtain, moody; grade darker + heavy vignette at render for the near-black focus beat                                                                     | see ATTRIBUTION.md (CC0)                                                    | `done`                               |


Render gate: Section 1 generated assets G1-G4 are present in `assets/` under their exact filenames.
...
| Done | Filename                                        | Type                | Used in scenes              | Description                                                                                                                                                                                                            | Prompt / Source                            | Status                                                |
| ---- | ----------------------------------------------- | ------------------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------------------------- |
| [x]  | `trophy-gold-parody.png`                        | reuse (video hero)  | 2.4, 2.5 (first made in S1) | shared-registry parody trophy - same file as Section 1 (Prompt G1)                                                                                                                                                     | S1 Prompt G1; one PNG serves all sections  | `done` (shared with S1) |
| [x]  | `red-supercar-generic.png`                      | generate            | 2.3, 2.4                    | generic red wedge supercar, glossy cherry red, badge-free, isolated with soft shadow, ZERO real marque cues                                                                                                            | Prompt S2-G1 below                         | `done`                                                |
| [x]  | `price-tag-blank.png`                           | generate            | 2.4, 2.5                    | blank cream paper swing/price tag on a rough string, one soft bend, TEXT-FREE (CSS supplies STATUS / BILLIONS... / PRESTIGE...)                                                                                        | Prompt S2-G2 below                         | `done`                                                |
| [x]  | `credit-card-taxpayer.png`                      | generate            | 2.4                         | oversized parody credit card, gold-tinted, generic chip, embossed `TAXPAYER`, NO network logos/holograms                                                                                                               | Prompt S2-G3 below                         | `done`                                                |
| [x]  | `wit-pool-float-shades.png`                     | generate (NEW pose) | 2.1                         | WIT as vacation believer: teal swim ring, black sunglasses, tiny umbrella drink, blissful open-mouth smile                                                                                                             | Prompt S2-G4 below (attach `_origin_.png`) | `done`                                                |
| [x]  | `poses/lecturing_finger_raised_eyes_closed.png` | pose                | 2.2                         | library truth-teller pose copy                                                                                                                                                                                         | `.agents/_shared/assets/wit/poses/`        | `done`                                                |
| [x]  | `poses/rich_flex_gold_chain_sunglasses.png`     | pose                | 2.3                         | library flex pose copy                                                                                                                                                                                                 | same                                       | `done`                                                |
| [x]  | `poses/panic_hands_on_cheeks_scream.png`        | pose                | 2.4                         | library peak-panic pose copy                                                                                                                                                                                           | same                                       | `done`                                                |
| [x]  | `poses/skeptical_side_eye_doubtful.png`         | pose                | 2.5                         | library squint pose (already copied in S1.2 - same file keeps WIT consistent)                                                                                                                                          | same                                       | `done` (reused)                                       |
| [x]  | `resort-pool-1.jpg`                             | browse-real-photo   | 2.1                         | sunny tropical resort pool, turquoise water, empty loungers, palms, no people, no brand signage (portrait original cropped to 16:9, left edge trimmed to drop one sunbather)                                           | see ATTRIBUTION.md (CC0)                   | `done`                                                |
| [x]  | `calculator-desk-1.jpg`                         | browse-real-photo   | 2.2                         | clean brand-free desktop calculator, no hands/people, isolated on a plain dark surface (base has no white paper; render supplies the CSS white paper sheets for the INVESTMENT?/PURCHASE markup + red display overlay) | see ATTRIBUTION.md (CC0)                   | `done`                                                |
| [x]  | `showroom-floor-1.jpg`                          | browse-real-photo   | 2.3                         | glossy pale reflective lobby floor, floor-to-ceiling daylight windows, no cars/dealer logos/people (chrome bollards in mid-ground are minor and sit behind the composited car)                                         | see ATTRIBUTION.md (CC0)                   | `done`                                                |
| [x]  | `marble-counter-1.jpg`                          | browse-real-photo   | 2.4                         | clean white-gray Carrara marble surface (cropped from a flat-lay's prop-free right region, upscaled to 1920x1080 - soft, low-frequency veining tolerates it; render adds the boutique blurred backdrop)                | see ATTRIBUTION.md (CC0)                   | `done`                                                |
| [x]  | `wallet-empty-1.jpg`                            | browse-real-photo   | 2.5                         | open empty brown leather wallet, card slots visibly empty, no brand, isolated on white studio bg (render places it on warm wood - e.g. grade or reuse `desk-darkwood-1.jpg` as the table)                              | see ATTRIBUTION.md (CC0)                   | `done`                                                |


Render gate: Section 2 generated assets are present in `assets/` under their exact filenames.
...
| Done | Filename                                               | Type                            | Used in scenes | Description                                                                                                                                                   | Prompt / Source                      | Status                                                |
| ---- | ------------------------------------------------------ | ------------------------------- | -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------- |
| [x]  | `receipt-endless-roll.png`                             | reuse (video motif)             | 3.1            | endless receipt (born S1.3); OPTIMISM $2,000,000 line item is CSS on top                                                                                      | S1 Prompt G2; shared motif file      | `done` (shared with S1) |
| [x]  | `promise-machine-contraption.png`                      | generate                        | 3.1            | brass fortune-teller carnival cabinet: glass dome + gold sparkles, scrollwork, side crank, coin slot, wide output slot; blank front (plaque is CSS); isolated | Prompt S3-G1                         | `done`                                                |
| [x]  | `impact-study-document.png`                            | generate                        | 3.2, 3.3, 3.8  | glossy parody report: navy cover, gold title `ECONOMIC IMPACT STUDY`, gold rule, firm mark `Big Numbers & Partners`; isolated                                 | Prompt S3-G2                         | `done`                                                |
| [x]  | `horoscope-spreadsheet-scroll.png`                     | generate                        | 3.2, 3.8       | midnight-purple scroll, gold zodiac-glyph ring, body = ruled spreadsheet grid + faint numbers + gold constellation lines; isolated                            | Prompt S3-G3                         | `done`                                                |
| [x]  | `balloon-shiny-gold.png`                               | generate                        | 3.3, 3.4       | glossy round gold party balloon, white highlight, short string, BLANK surface (labels are CSS); isolated                                                      | Prompt S3-G4                         | `done`                                                |
| [x]  | `balloon-shiny-teal.png`                               | generate                        | 3.3, 3.4       | glossy round teal party balloon, same style, blank, string; isolated                                                                                          | Prompt S3-G5                         | `done`                                                |
| [x]  | `wit-hypnotized-numbers.png`                           | generate (NEW pose)             | 3.3            | WIT full body, head up, awed "o" mouth, pupils replaced by rising-digit streams + upward spiral inside the glasses; no costume                                | Prompt S3-G6 (attach `_origin_.png`) | `done`                                                |
| [x]  | `red-pushpin-giant.png`                                | generate                        | 3.4            | oversized red pushpin: glossy round red head, steel needle, point leading; isolated                                                                           | Prompt S3-G7                         | `done`                                                |
| [x]  | `suitcase-vintage-tourist.png`                         | generate                        | 3.5            | worn vintage leather suitcase, brass corners, a few generic shape stickers (sun, wave, mountain - no flags/brands/city names); isolated                       | Prompt S3-G8                         | `done`                                                |
| [x]  | `airmail-envelope-ticket.png`                          | generate                        | 3.6            | white airmail envelope (red-blue chevron border, plain `AIR MAIL`), generic parody `BOARDING PASS` ticket poking out (plane silhouette, no airline); isolated | Prompt S3-G9                         | `done`                                                |
| [x]  | `banknote-hundred-parody.png`                          | generate                        | 3.7            | generic parody banknote: mint-green, `100` corners, laurel-wreathed globe center oval (no person, not a real currency), guilloche border; isolated            | Prompt S3-G10                        | `done`                                                |
| [x]  | `coin-gold-one.png`                                    | generate                        | 3.7 (x2)       | single gold coin embossed `1`, slight perspective, soft shine; isolated                                                                                       | Prompt S3-G11                        | `done`                                                |
| [x]  | `coin-gold-half.png`                                   | generate                        | 3.7            | half-sized gold coin embossed `50`, same style; isolated                                                                                                      | Prompt S3-G12                        | `done`                                                |
| [x]  | `mailbox-red-generic.png`                              | generate (fallback, was browse) | 3.6            | generic bright red street postbox, NO national emblem / royal cypher / postal branding / text; isolated, transparent (render adds the sunny bokeh backdrop)   | Prompt S3-G13                        | `done`                                                |
| [x]  | `poses/proud_explaining_hand_on_chest_hand_on_hip.png` | pose                            | 3.1            | library mock-grand showman                                                                                                                                    | `.agents/_shared/assets/wit/poses/`  | `done`                                                |
| [x]  | `poses/unimpressed_smirk_closeup.png`                  | pose                            | 3.2            | library dry-smirk closeup                                                                                                                                     | same                                 | `done`                                                |
| [x]  | `poses/smug_raised_eyebrow_smirk.png`                  | pose                            | 3.4            | library reality-auditor smirk                                                                                                                                 | same                                 | `done`                                                |
| [x]  | `poses/shocked_sweating_dismayed.png`                  | pose                            | 3.5            | library bill-shock reaction                                                                                                                                   | same                                 | `done`                                                |
| [x]  | `poses/shrug_both_hands_up_smile.png`                  | pose                            | 3.6            | library nonchalant shrug                                                                                                                                      | same                                 | `done`                                                |
| [x]  | `poses/exhausted_dead_inside_eye_bags.png`             | pose                            | 3.7            | library dead-inside stare                                                                                                                                     | same                                 | `done`                                                |
| [x]  | `poses/reading_book_round_glasses_studious.png`        | pose                            | 3.8            | library studious economist                                                                                                                                    | same                                 | `done`                                                |
| [x]  | `fairground-lights-1.jpg`                              | browse-real-photo               | 3.1            | glowing carnival booth at dusk, people-free (cropped from a midway shot), bulb strings; render blurs as background                                            | see ATTRIBUTION.md (CC BY 2.0)       | `done`                                                |
| [x]  | `marble-boardroom-1.jpg`                               | browse-real-photo               | 3.2            | dark green-black marble texture; render adds warm spotlight pool                                                                                              | see ATTRIBUTION.md (CC BY 2.0)       | `done`                                                |
| [x]  | `blue-sky-clouds-1.jpg`                                | browse-real-photo               | 3.3            | bright blue sky + puffy cumulus, no ground/people                                                                                                             | see ATTRIBUTION.md (CC0)             | `done`                                                |
| [x]  | `airport-arrivals-1.jpg`                               | browse-real-photo               | 3.4            | empty gate lounge, no people; distant Delta tails through window (render blurs the window band)                                                               | see ATTRIBUTION.md (CC0)             | `done`                                                |
| [x]  | `baggage-carousel-1.jpg`                               | browse-real-photo               | 3.5            | empty baggage carousel belt curving through frame, no signage                                                                                                 | see ATTRIBUTION.md (CC0)             | `done`                                                |
| [x]  | `stadium-turnstile-1.jpg`                              | browse-real-photo               | 3.7            | metro turnstile row (substitutes for stadium turnstiles), people-free, no brand                                                                               | see ATTRIBUTION.md (CC0)             | `done`                                                |
| [x]  | `party-aftermath-1.jpg`                                | browse-real-photo               | 3.8            | confetti + streamers on the ground, no people/brands (concrete; render warm-grades + adds deflated balloons)                                                  | see ATTRIBUTION.md (CC BY 2.0)       | `done`                                                |


Render gate: Section 3 generated assets S3-G1..G13 and the shared `receipt-endless-roll.png`
are present in `assets/` under their exact filenames.
...
| Done | Filename                                    | Type                            | Used in scenes   | Description                                                                                                         | Prompt / Source                            | Status                                                |
| ---- | ------------------------------------------- | ------------------------------- | ---------------- | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ | ----------------------------------------------------- |
| [x]  | `contract-stack-guarantees.png`             | generate                        | 4.1              | fat askew stack of ~15 white contract pages, blank top page (CSS titles it), isolated                               | Prompt S4-G1                               | `done`                                                |
| [x]  | `wit-mayor-signing.png`                     | generate (NEW pose)             | 4.1              | WIT: blank teal mayoral sash, eyes-closed bliss, signing with a smoking fountain pen                                | Prompt S4-G2 (attach `_origin_.png`)       | `done`                                                |
| [x]  | `gold-safe-fat.png`                         | generate                        | 4.2, 4.5, 4.7    | overstuffed gold safe, bulging sides + bowing door seam, round black dial, isolated                                 | Prompt S4-G3                               | `done`                                                |
| [x]  | `cash-bundle-generic.png`                   | generate                        | 4.2, 4.7, 4.9    | single banknote bundle, generic green bills + plain band, NO real currency, isolated                                | Prompt S4-G4                               | `done`                                                |
| [x]  | `wood-sign-hanging-blank.png`               | generate                        | 4.6              | blank rustic wooden hanging signboard on two ropes, text-free (CSS writes on it), isolated                          | Prompt S4-G5                               | `done`                                                |
| [x]  | `gold-bar-single.png`                       | generate                        | 4.6 (x4 stacked) | single gleaming gold bar, blank raised panel (no text), isolated - render stacks copies                             | Prompt S4-G6                               | `done`                                                |
| [x]  | `money-sack-gold.png`                       | generate                        | 4.8              | fat tied gold-tinted canvas money sack, plain embossed `$` only, isolated                                           | Prompt S4-G7                               | `done`                                                |
| [x]  | `auctioneer-at-podium.png`                  | generate                        | 4.9              | FACELESS suited figure behind a wooden podium, sweeping a money-rake, isolated (institution, not a person)          | Prompt S4-G8                               | `done`                                                |
| [x]  | `wit-auction-winner-paddle.png`             | generate (NEW pose)             | 4.9              | WIT: blank white bidding paddle raised, long folded bill over forearm, proud-but-terrified                          | Prompt S4-G9 (attach `_origin_.png`)       | `done`                                                |
| [x]  | `trophy-gold-parody.png`                    | reuse (shared)                  | 4.9              | video hero trophy as the auction lot                                                                                | S1 Prompt G1 (one PNG serves all sections) | `done` (shared with S1) |
| [x]  | `receipt-endless-roll.png`                  | reuse (shared)                  | 4.3              | video motif receipt; CSS prints `16x STADIUM (RETROFIT) ......... $???`                                             | S1 Prompt G2                               | `done` (shared with S1) |
| [x]  | `poses/unimpressed_smirk_closeup.png`       | pose                            | 4.2              | library dry-smirk closeup                                                                                           | `.agents/_shared/assets/wit/poses/`        | `done` (reused)                                       |
| [x]  | `poses/shocked_sweating_dismayed.png`       | pose                            | 4.3              | library dismay pose                                                                                                 | same                                       | `done` (reused)                                       |
| [x]  | `poses/deadpan_unimpressed_half_lidded.png` | pose                            | 4.4              | library signature deadpan                                                                                           | same                                       | `done` (reused)                                       |
| [x]  | `poses/pointing_at_globe_explaining.png`    | pose                            | 4.5              | library geography/pointing pose                                                                                     | same                                       | `done`                                                |
| [x]  | `poses/rich_flex_gold_chain_sunglasses.png` | pose                            | 4.6              | library flex pose                                                                                                   | same                                       | `done` (reused)                                       |
| [x]  | `poses/mildly_surprised_hand_at_chin.png`   | pose                            | 4.7              | library impressed-against-his-will pose                                                                             | same                                       | `done`                                                |
| [x]  | `poses/eyes_closed_talking_open_palm.png`   | pose                            | 4.8              | library calm-concession pose                                                                                        | same                                       | `done`                                                |
| [x]  | `boardroom-table-1.jpg`                     | browse-real-photo               | 4.1              | long dark-wood boardroom table, empty leather chairs, warm daylight, no people/brands                               | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `tv-wall-glow-1.jpg`                        | generate (fallback, was browse) | 4.2              | full-frame dark wall of glowing blank white-blue TV screens, no logos/content/people (no license-safe photo exists) | Prompt S4-G10 below                        | `done`                                                |
| [x]  | `stadium-construction-crane-1.jpg`          | browse-real-photo               | 4.3              | stadium concrete bowl under construction, tower cranes at dusk, no workers/logos                                    | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `rubber-stamp-ink-1.jpg`                    | browse-real-photo               | 4.4              | wooden rubber stamp on a red ink pad, bright desk, no readable stamp face/brands                                    | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `alpine-lake-town-1.jpg`                    | browse-real-photo               | 4.5              | bright alpine lake + peaks + small town; GENERIC (no landmarks), no flags, people-free                              | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `chessboard-closeup-1.jpg`                  | browse-real-photo               | 4.6              | wooden chessboard mid-game, warm shallow focus, no hands/brands                                                     | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `vault-door-1.jpg`                          | browse-real-photo               | 4.7              | massive round steel bank vault door, ajar, cool metal, no bank brands/people                                        | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `balance-scale-brass-1.jpg`                 | browse-real-photo               | 4.8              | antique brass two-pan balance scale on wood, both pans level, no brands                                             | see ATTRIBUTION.md                         | `done`                                                |
| [x]  | `auction-gavel-1.jpg`                       | browse-real-photo               | 4.9              | wooden auctioneer gavel on sound block, warm spotlight, dark room, no people/branding                               | see ATTRIBUTION.md                         | `done`                                                |


Render gate: Section 4 generated assets S4-G1..S4-G10, shared reuses, and sourced browse bases are
present in `assets/` under their exact filenames.
...
| Done | Filename                                        | Type                | Used in scenes          | Description                                                                                                            | Prompt / Source                      | Status                                                |
| ---- | ----------------------------------------------- | ------------------- | ----------------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------- |
| [x]  | `wit-minister-sash-shouting.png`                | generate (NEW pose) | 5.1                     | WIT: dark suit jacket + blank teal pageant sash + white megaphone, mouth open mid-shout                                | Prompt S5-G1 (attach `_origin_.png`) | `done`                                                |
| [x]  | `money-pile-party.png`                          | generate            | 5.1, 5.2, 5.4, 5.6      | mound of parody teal-cream play-money + confetti (NO real currency), isolated - shrinks by CSS scale                   | Prompt S5-G2                         | `done`                                                |
| [x]  | `drain-grate-ornate.png`                        | generate            | 5.1 (x3), 5.2, 5.4, 5.6 | ornate round cast-iron storm-drain grate, blank curved name plate (CSS labels it), isolated                            | Prompt S5-G3                         | `done`                                                |
| [x]  | `banknote-single-crisp.png`                     | generate            | 5.2, 5.4, 5.5, 5.6      | one crisp parody teal-cream banknote, generic ornament, NO real currency, isolated                                     | Prompt S5-G4                         | `done`                                                |
| [x]  | `banknote-seated-fan.png`                       | generate            | 5.3 (x4)                | parody banknote folded to sit upright like a tiny flat spectator, isolated                                             | Prompt S5-G5                         | `done`                                                |
| [x]  | `ticket-match-stub.png`                         | generate            | 5.3                     | blank sports match ticket stub, perforated edge, empty boxes (CSS text), isolated                                      | Prompt S5-G6                         | `done`                                                |
| [x]  | `ticket-cinema-stub.png`                        | generate            | 5.3                     | blank cinema ticket stub, film-strip edge, empty price box (CSS text), isolated                                        | Prompt S5-G7                         | `done`                                                |
| [x]  | `shopfront-mobbed.png`                          | generate            | 5.5                     | festive shop facade: open door, bunting, packed window, bursting register, bag queue (NO people), blank sign, isolated | Prompt S5-G8                         | `done`                                                |
| [x]  | `shopfront-empty-cobwebs.png`                   | generate            | 5.5                     | grey shuttered shop facade, cobwebs, empty tip jar, same style as the mobbed one, isolated                             | Prompt S5-G9                         | `done`                                                |
| [x]  | `signpost-zurich.png`                           | generate            | 5.6                     | rustic wooden signpost, ONE blank right-arrow plank (CSS labels ZURICH), isolated                                      | Prompt S5-G10                        | `done`                                                |
| [x]  | `banknote-flying-flock.png`                     | generate            | 5.6 (x2)                | 2-3 parody banknotes mid-flight with motion curl, like startled birds, isolated                                        | Prompt S5-G11                        | `done`                                                |
| [x]  | `banknote-walking-guest.png`                    | generate            | 5.7 (x3)                | parody banknote with cartoon legs mid-stride carrying a tiny suitcase, isolated                                        | Prompt S5-G12                        | `done`                                                |
| [x]  | `receipt-endless-roll.png`                      | reuse (shared)      | 5.7                     | video motif receipt pinned to the door face (no CSS items this section)                                                | S1 Prompt G2                         | `done` (shared with S1) |
| [x]  | `poses/lecturing_finger_raised_eyes_closed.png` | pose                | 5.2                     | library professor pose                                                                                                 | `.agents/_shared/assets/wit/poses/`  | `done` (reused)                                       |
| [x]  | `poses/unimpressed_smirk_closeup.png`           | pose                | 5.3                     | library dry-smirk closeup                                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/worried_uneasy_wide_eyes.png`            | pose                | 5.4                     | library uneasy wide-eyes (hiding local)                                                                                | same                                 | `done`                                                |
| [x]  | `poses/shocked_sweating_dismayed.png`           | pose                | 5.5                     | library dismay pose                                                                                                    | same                                 | `done` (reused)                                       |
| [x]  | `poses/panic_hands_on_cheeks_scream.png`        | pose                | 5.6                     | library full-panic scream                                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/exhausted_dead_inside_eye_bags.png`      | pose                | 5.7                     | library dead-inside pose                                                                                               | same                                 | `done` (reused)                                       |
| [x]  | `confetti-plaza-1.jpg`                          | browse-real-photo   | 5.1                     | bright people-free plaza/street strewn with confetti + streamers, no brands/flags                                      | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `wallet-open-1.jpg`                             | browse-real-photo   | 5.2                     | worn brown leather wallet open in close-up, generic bill edges, warm light, no logos/cards                             | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `cinema-red-seats-1.jpg`                        | browse-real-photo   | 5.3                     | empty cinema auditorium, red velvet seat rows, warm screen glow, no people/brands                                      | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `suitcase-stack-1.jpg`                          | browse-real-photo   | 5.4                     | wall of stacked colorful vintage suitcases, tightly packed, no brand stickers/people                                   | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `cobblestone-street-1.jpg`                      | browse-real-photo   | 5.5                     | bright people-free cobblestone shopping street, plain building faces, no readable signs                                | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `stadium-exterior-day-1.jpg`                    | browse-real-photo   | 5.6                     | modern stadium exterior by day, empty forecourt, no people, no readable sponsor boards                                 | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `front-door-balloons-1.jpg`                     | browse-real-photo   | 5.7                     | house front door with party balloons + doorstep confetti, morning light, no people/house number                        | see ATTRIBUTION.md                   | `done`                                                |


Render gate: Section 5 render is READY. The 12 Section-5 `generate` PNGs (S5-G1..G12), the shared
`receipt-endless-roll.png`, and all 7 browse bases are in `assets/`.
...
| Done | Filename                                    | Type                | Used in scenes | Description                                                                                            | Prompt / Source                      | Status                                                |
| ---- | ------------------------------------------- | ------------------- | -------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------ | ----------------------------------------------------- |
| [x]  | `pennant-string-drooping.png`               | generate            | 6.1            | string of plain teal/gold/red triangle pennants, sagging, left end torn loose, isolated                | Prompt S6-G1                         | `done`                                                |
| [x]  | `elephant-stadium-pet.png`                  | generate            | 6.2            | hybrid pet: concrete stadium-bowl body + grey elephant head/trunk/ears/legs, sad droopy eyes, isolated | Prompt S6-G2                         | `done`                                                |
| [x]  | `feeding-bowl-maintenance.png`              | generate            | 6.2, 6.7       | oversized red pet bowl, white `MAINTENANCE` painted on front, heaped with gold coins, isolated         | Prompt S6-G3                         | `done`                                                |
| [x]  | `wit-party-hat-feeding-scoop.png`           | generate (NEW pose) | 6.2            | WIT: teal polka-dot party hat + chin strap, deadpan, gripping a coin-heaped feed scoop mid-pour        | Prompt S6-G4 (attach `_origin_.png`) | `done`                                                |
| [x]  | `bus-row-parked.png`                        | generate            | 6.4 (x3 rows)  | one row of 5 plain white/teal-stripe buses, no names/plates, nose-to-tail, isolated                    | Prompt S6-G5                         | `done`                                                |
| [x]  | `stadium-bowl-tiny.png`                     | generate            | 6.5            | small generic round white arena bowl, 3/4 aerial, generic (not any real venue), isolated               | Prompt S6-G6                         | `done`                                                |
| [x]  | `wit-magnifying-glass-search.png`           | generate (NEW pose) | 6.5            | WIT: leaning forward with a giant magnifying glass, one eye hugely enlarged through the lens           | Prompt S6-G7 (attach `_origin_.png`) | `done`                                                |
| [x]  | `birthday-cake-one-candle.png`              | generate            | 6.6            | small white-frosted birthday cake, pastel sprinkles, ONE lit candle, on a paper plate, isolated        | Prompt S6-G8                         | `done`                                                |
| [x]  | `fridge-white-magnets.png`                  | generate            | 6.7            | plain white two-door fridge, blank door + a few round magnets (CSS card sits on top), isolated         | Prompt S6-G9                         | `done`                                                |
| [x]  | `microphone-stand-gold.png`                 | generate            | 6.8            | classic round-head gold microphone on a black stand, one glint, isolated                               | Prompt S6-G10                        | `done`                                                |
| [x]  | `receipt-endless-roll.png`                  | reuse (shared)      | 6.7            | video motif receipt; CSS prints `1x WHITE ELEPHANT (FEEDING, ANNUAL) ......... $???`                   | S1 Prompt G2                         | `done` (shared with S1) |
| [x]  | `poses/sleepy_yawning_open_mouth.png`       | pose                | 6.1            | library morning-after yawn                                                                             | `.agents/_shared/assets/wit/poses/`  | `done`                                                |
| [x]  | `poses/mildly_surprised_hand_at_chin.png`   | pose                | 6.3            | library impressed-but-doubtful                                                                         | same                                 | `done` (reused)                                       |
| [x]  | `poses/deadpan_unimpressed_half_lidded.png` | pose                | 6.4            | library signature deadpan                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/ok_hand_sign_content_closeup.png`    | pose                | 6.6            | library dry OK-sign approval                                                                           | same                                 | `done`                                                |
| [x]  | `poses/exhausted_dead_inside_eye_bags.png`  | pose                | 6.7            | library dead-inside fatigue                                                                            | same                                 | `done` (reused)                                       |
| [x]  | `poses/shrug_both_hands_up_smile.png`       | pose                | 6.8            | library relieved shrug                                                                                 | same                                 | `done` (reused)                                       |
| [x]  | `stadium-empty-seats-dawn-1.jpg`            | browse-real-photo   | 6.1            | empty stadium interior at dawn, curved colored seat rows, cool light, no people/ads                    | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `grass-field-morning-1.jpg`                 | browse-real-photo   | 6.2            | wide empty grass field/park lawn, bright morning sky, no people/signage                                | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `stadium-modern-exterior-1.jpg`             | browse-real-photo   | 6.3            | monumental modern stadium exterior, white columns, empty plaza, no people/branding                     | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `stadium-parking-lot-1.jpg`                 | browse-real-photo   | 6.4            | vast empty stadium parking lot, painted lines, roofline in bg, no people/plates                        | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `rainforest-aerial-1.jpg`                   | browse-real-photo   | 6.5            | aerial dense rainforest canopy + river bend, no clearings/buildings/people                             | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `pitch-center-circle-1.jpg`                 | browse-real-photo   | 6.6            | football pitch at ground level, white center circle, empty blurred stands, no people/marks             | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `kitchen-bright-1.jpg`                      | browse-real-photo   | 6.7            | bright kitchen, counter + tiles + window light, no people/appliance brands                             | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `concert-stage-lights-1.jpg`                | browse-real-photo   | 6.8            | concert stage lighting rig at night, magenta/violet beams + haze, empty stage, no people/marks         | see ATTRIBUTION.md                   | `done`                                                |


Render gate: Section 6 render is READY. The 10 Section-6 `generate` PNGs (S6-G1..G10), the shared
`receipt-endless-roll.png`, and all 8 browse bases are in `assets/`.
...
| Done | Filename                                    | Type                | Used in scenes | Description                                                                                                            | Prompt / Source                      | Status                                                |
| ---- | ------------------------------------------- | ------------------- | -------------- | ---------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------- |
| [x]  | `podium-suits-trio.png`                     | generate            | 7.1, 7.2, 7.3  | three FACELESS suited figures (blank heads) behind one wooden podium, one mid-wave, isolated                           | Prompt S7-G1                         | `done`                                                |
| [x]  | `receipt-conveyor-machine.png`              | generate            | 7.1            | chunky industrial conveyor-belt machine with rollers + output ramp, unbranded, isolated                                | Prompt S7-G2                         | `done`                                                |
| [x]  | `wit-tiny-taxpayer-catching-receipt.png`    | generate (NEW pose) | 7.1 (x3)       | tiny full-body WIT, arms up catching a falling receipt strip, overwhelmed, one sweat drop                              | Prompt S7-G3 (attach `_origin_.png`) | `done`                                                |
| [x]  | `bill-envelope-overdue.png`                 | generate            | 7.3            | worn white envelope, one red diagonal corner stripe, text-free (CSS adds stamp/date), isolated                         | Prompt S7-G4                         | `done`                                                |
| [x]  | `prestige-crown-glow.png`                   | generate            | 7.4            | small radiant golden crown with a soft warm glow aura + sparkles, isolated                                             | Prompt S7-G5                         | `done`                                                |
| [x]  | `rubber-stamp-red.png`                      | generate            | 7.4            | wooden-handle rubber stamp with red base, mid-slam, blank rubber face (CSS text), isolated                             | Prompt S7-G6                         | `done`                                                |
| [x]  | `ballot-box-wood.png`                       | generate            | 7.5            | classic wooden ballot box, brass top slot + small brass padlock, isolated                                              | Prompt S7-G7                         | `done`                                                |
| [x]  | `applause-meter-dial.png`                   | generate            | 7.6            | vintage carnival applause-o-meter, half-circle cream dial + brass rim + red needle, blank plate (CSS labels), isolated | Prompt S7-G8                         | `done`                                                |
| [x]  | `wallet-padlocked-city.png`                 | generate            | 7.7            | fat brown wallet wrapped in a steel chain + chunky brass padlock, isolated                                             | Prompt S7-G9                         | `done`                                                |
| [x]  | `surplus-jar-coins.png`                     | generate            | 7.7            | clear glass jar full of gold coins, paper lid tied with string, label-free (CSS labels), isolated                      | Prompt S7-G10                        | `done`                                                |
| [x]  | `clickbait-ad-card.png`                     | generate            | 7.8            | parody 2000s popup-ad card, garish magenta/cyan border, starburst, fake X, blank center (CSS copy), isolated           | Prompt S7-G11                        | `done`                                                |
| [x]  | `bill-stack-invoices.png`                   | generate            | 7.9            | thick stack of white invoices, ruffled edges, one red rubber band, faint unreadable print, isolated                    | Prompt S7-G12                        | `done`                                                |
| [x]  | `trophy-gold-parody.png`                    | reuse (shared)      | 7.2            | video hero trophy as photo-op prop                                                                                     | S1 Prompt G1                         | `done` (shared with S1) |
| [x]  | `receipt-endless-roll.png`                  | reuse (shared)      | 7.1, 7.9       | video motif receipt: conveyor feed (7.1) + closing bottom roll (7.9)                                                   | S1 Prompt G2                         | `done` (shared with S1) |
| [x]  | `poses/shrug_confused_flat_mouth.png`       | pose                | 7.1            | library blank confused shrug                                                                                           | `.agents/_shared/assets/wit/poses/`  | `done`                                                |
| [x]  | `poses/unimpressed_smirk_closeup.png`       | pose                | 7.2            | library dry witness                                                                                                    | same                                 | `done` (reused)                                       |
| [x]  | `poses/pointing_at_globe_explaining.png`    | pose                | 7.3            | library map-pointing pose                                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/mildly_surprised_hand_at_chin.png`   | pose                | 7.4            | library doubtful "huh"                                                                                                 | same                                 | `done` (reused)                                       |
| [x]  | `poses/furious_shouting_anger_mark.png`     | pose                | 7.5            | library mid-shout fury                                                                                                 | same                                 | `done`                                                |
| [x]  | `poses/deadpan_unimpressed_half_lidded.png` | pose                | 7.6            | library signature deadpan                                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/ok_hand_sign_content_closeup.png`    | pose                | 7.7            | library content approval                                                                                               | same                                 | `done` (reused)                                       |
| [x]  | `poses/smug_sly_smirk_leaning.png`          | pose                | 7.8            | library salesman lean                                                                                                  | same                                 | `done`                                                |
| [x]  | `poses/shrug_both_hands_up_smile.png`       | pose                | 7.9            | library resigned smiling shrug                                                                                         | same                                 | `done` (reused)                                       |
| [x]  | `rope-tug-frayed-1.jpg`                     | browse-real-photo   | 7.1            | one thick frayed tug-of-war rope pulled taut, diagonal, no people/hands                                                | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `red-carpet-stanchions-1.jpg`               | browse-real-photo   | 7.2            | red carpet + gold stanchions to a small empty stage, no people, warm light                                             | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `map-atlas-colored-1.jpg`                   | browse-real-photo   | 7.3            | bright colored school atlas double-page spread, top-down, no country emphasized, no flags                              | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `calculator-spreadsheet-1.jpg`              | browse-real-photo   | 7.4            | chunky desk calculator on printed spreadsheet pages, top-down, no hands/brand                                          | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `voting-booth-1.jpg`                        | browse-real-photo   | 7.5            | polling booth with pleated navy privacy curtain + shelf, empty, no people/signage                                      | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `auditorium-seats-1.jpg`                    | browse-real-photo   | 7.6            | rows of empty red auditorium seats, soft focus, no people/venue branding                                               | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `palm-trees-sky-1.jpg`                      | browse-real-photo   | 7.7            | tall palm trees against clean blue sunny sky, low angle, no buildings/people/landmarks                                 | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `crt-monitor-retro-1.jpg`                   | browse-real-photo   | 7.8            | retro beige CRT monitor on a desk, screen glowing blank, no brand/people                                               | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `city-hall-columns-1.jpg`                   | browse-real-photo   | 7.9            | generic stone civic building facade with columns, straight-on, no landmark/signage/people                              | see ATTRIBUTION.md                   | `done`                                                |


Render gate: Section 7 render is READY. The 12 Section-7 `generate` PNGs (S7-G1..G12), the two shared
reuses (`trophy-gold-parody.png`, `receipt-endless-roll.png`), and all 9 browse bases are in `assets/`.
...
| Done | Filename                                  | Type                | Used in scenes                  | Description                                                                                               | Prompt / Source                      | Status                                                |
| ---- | ----------------------------------------- | ------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------- | ------------------------------------ | ----------------------------------------------------- |
| [x]  | `tag-paper-string.png`                    | generate            | 8.1 (x3)                        | single blank cream luggage-style paper tag on rough string (CSS text; composited 3x), isolated            | Prompt S8-G1                         | `done`                                                |
| [x]  | `coin-jar-glass.png`                      | generate            | 8.2                             | clear glass jar half full of assorted coins, no lid, label-free (CSS label), isolated                     | Prompt S8-G2                         | `done`                                                |
| [x]  | `phone-frame-plain.png`                   | generate            | 8.3                             | large plain portrait smartphone, blank dark screen, slim selfie-stick clamp on bottom, no logos, isolated | Prompt S8-G3                         | `done`                                                |
| [x]  | `wit-selfie-stick-calm.png`               | generate (NEW pose) | 8.3                             | WIT: full body, one arm up holding a selfie stick with a small dark phone, calm faint smile, eyes up      | Prompt S8-G4 (attach `_origin_.png`) | `done`                                                |
| [x]  | `marker-red-uncapped.png`                 | generate            | 8.5                             | red marker pen, cap off, isolated                                                                         | Prompt S8-G5                         | `done`                                                |
| [x]  | `balloon-deflated-grey.png`               | generate            | 8.6                             | single grey half-deflated wrinkled party balloon on a thin string, isolated                               | Prompt S8-G6                         | `done`                                                |
| [x]  | `wit-calm-resigned-nod.png`               | generate (NEW pose) | 8.6                             | WIT: relaxed, eyes gently closed, small knowing smile, chin dipped, holding a small blank ticket stub     | Prompt S8-G7 (attach `_origin_.png`) | `done`                                                |
| [x]  | `trophy-gold-parody.png`                  | reuse (shared)      | 8.1, 8.3 (in phone screen), 8.6 | video hero trophy, desaturated souvenir grade                                                             | S1 Prompt G1                         | `done` (shared with S1) |
| [x]  | `receipt-endless-roll.png`                | reuse (shared)      | 8.1, 8.2, 8.5, 8.6              | video motif receipt; 8.5 close-up is the thesis frame (all item/name text is CSS)                         | S1 Prompt G2                         | `done` (shared with S1) |
| [x]  | `poses/eyes_closed_talking_open_palm.png` | pose                | 8.1                             | library calm matter-of-fact narration                                                                     | `.agents/_shared/assets/wit/poses/`  | `done` (reused)                                       |
| [x]  | `poses/skeptical_side_eye_doubtful.png`   | pose                | 8.2                             | library half-lidded side-eye                                                                              | same                                 | `done` (reused)                                       |
| [x]  | `poses/unimpressed_smirk_closeup.png`     | pose                | 8.4                             | library dry smirk closeup                                                                                 | same                                 | `done` (reused)                                       |
| [x]  | `poses/mildly_surprised_hand_at_chin.png` | pose                | 8.5                             | library "reading the bill" pose                                                                           | same                                 | `done` (reused)                                       |
| [x]  | `mantel-livingroom-1.jpg`                 | browse-real-photo   | 8.1, 8.6                        | quiet living-room fireplace mantel, pale wall, soft light, no people/brands/framed faces                  | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `office-empty-chair-1.jpg`                | browse-real-photo   | 8.2                             | empty executive office, desk + empty leather chair slightly turned, no people/brands/papers               | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `overlook-railing-dusk-1.jpg`             | browse-real-photo   | 8.3                             | scenic overlook railing at dusk, wide grey-blue sky, distant lights, no people/landmark                   | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `cash-counter-machine-1.jpg`              | browse-real-photo   | 8.4                             | currency-counting machine mid-count, fanned notes, plain counter, no hands/brands/readable portraits      | see ATTRIBUTION.md                   | `done`                                                |
| [x]  | `coffee-table-lamp-1.jpg`                 | browse-real-photo   | 8.5                             | dark wooden coffee table at night under one warm lamp pool, blurred quiet room, no people/brands          | see ATTRIBUTION.md                   | `done`                                                |


Render gate: Section 8 render is READY. The 7 Section-8 `generate` PNGs (S8-G1..G7), the two shared
reuses (`trophy-gold-parody.png`, `receipt-endless-roll.png`), and all 5 browse bases are in `assets/`.
...
| Done | Filename                               | Type              | Used in scenes            | Description                                                                                                  | Prompt / Source                     | Status                                                |
| ---- | -------------------------------------- | ----------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------ | ----------------------------------- | ----------------------------------------------------- |
| [x]  | `trophy-gold-parody.png`               | reuse (shared)    | 9.1, 9.2 (card thumbnail) | video hero trophy, warmest grade; final two appearances                                                      | S1 Prompt G1                        | `done` (shared with S1) |
| [x]  | `receipt-endless-roll.png`             | reuse (shared)    | 9.1                       | video motif receipt, final appearance; CSS prints `TOTAL: $0.00` + tear-off                                  | S1 Prompt G2                        | `done` (shared with S1) |
| [x]  | `poses/peace_sign_calm_open_mouth.png` | pose              | 9.x                       | library calm peace-sign sign-off pose                                                                        | `.agents/_shared/assets/wit/poses/` | `done`                                                |
| [x]  | `cafe-counter-warm-1.jpg`              | browse-real-photo | 9.1                       | warm-lit wooden cafe counter, amber side light, warm bokeh, one out-of-focus cup, no people/brands           | see ATTRIBUTION.md                  | `done`                                                |
