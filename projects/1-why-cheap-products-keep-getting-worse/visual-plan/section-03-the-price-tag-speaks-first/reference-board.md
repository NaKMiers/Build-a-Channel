...
| Current WIT pose set | Local reusable channel asset | `projects/1-why-cheap-products-keep-getting-worse/assets/wit/manifest.json` | `safe asset` | WIT shows temptation, fast wallet approval, confusion, deadpan marketing judgment, and final defeat. | WIT should stay large and emotionally readable. | Use exact listed PNG pose files only. | `assets/wit/` |
