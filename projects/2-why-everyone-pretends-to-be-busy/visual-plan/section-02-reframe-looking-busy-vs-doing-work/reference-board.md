# Section 2 Reference Board (v2 remake)

## Reference Pass Status
- Status: `completed (4 real people-free photo bases + real-UI Google Meet grid in CSS)`
...
## CSS-built on top
- Scene C: a small Google Meet call grid (meet icon + initials-avatar tiles) floated over the hands-typing photo, plus MEETINGS · TYPING · A SERIOUS FACE labels.
...
## Note
v2 remake to the new standard: real photo base behind EVERY scene + real-UI for the visible-busy beat + GIANT high WIT. The bulb is reused as a deliberate B↔D bookend (real progress is invisible → real work hides). People-free (hands OK), editorial real-UI.
