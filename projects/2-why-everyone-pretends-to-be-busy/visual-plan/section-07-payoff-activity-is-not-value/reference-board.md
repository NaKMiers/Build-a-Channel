# Section 7 Reference Board

## Reference Pass Status
- Status: `completed (3 real people-free photo bases + real-UI boards/chat/calendar in CSS)`
- Generated images: none.

## References (people-free / hands-OK, brand-safe, distinct)
| Ref | Type | Source | Class | Why useful | Use |
|---|---|---|---|---|---|
| base-question.jpg | CC0 photo | StockSnap | safe base | "?" sticky note + crumpled paper = "why does everyone pretend to be busy?" | Scene A (+ E behind calendar) |
| base-busy.jpg | CC0 photo | StockSnap | safe base | hands typing on a dark-wood desk = busy/available/fast (hands OK, no logos) | Scene B (+ D behind chat) |
| base-culture.jpg | CC BY 2.0 photo | Wikimedia (laptop in warm office) | safe base | a laptop in a blurred warm office = the wider work culture "everyone joins in" | Scene C |
| icons/gcal.png | trademark logo (editorial) | Wikimedia Commons | real-UI icon | Google Calendar header on the closing "calendar with Wi-Fi" | Scene E |
