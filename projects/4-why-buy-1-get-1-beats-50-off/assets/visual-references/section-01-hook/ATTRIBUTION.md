...
Notes:
- 2026-06-24 review swap (owner feedback "scene 1 and 2 images aren't suitable"): Scene A → greengrocer storefront (clearly a store, brand-free, people-free; dark-left composition suits the labels). Scene B → rising gold coin stacks (reads as "store profit doubling," echoes the profit meter). Both viewed and confirmed brand-free + people-free; both CC0. Old `base-a-shopping-cart.jpg` / `base-b-cash-usd.jpg` kept on disk as history but no longer referenced by `index.html` or the review mirror.
- CC BY-SA 3.0 (the magic hat) requires crediting "Magicianidris" and keeping a share-alike note. Put the credit in the YouTube description if this asset ships in the final render.
- Rejected (brand-bearing, not saved): snack aisle (Lay's/Pringles/Doritos), liquor aisle (branded bottles), detergent shelf (branded bottles). The channel rubric rejects recognizable logos for incidental backgrounds.
