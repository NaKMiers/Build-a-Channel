...
- Working title: `Why Buy 1 Get 1 Free Beats 50% Off`
...
Project-local browse skill not vendored; used global gstack `/browse`. General search engines
were not relied on (history of bot-blocks from this IP); sources were direct-fetched from
Wikipedia article bodies (`.mw-parser-output`), confirmed by title/text read. Investopedia
returned an automated-access block (recorded, not used). Demand references via YouTube search.
...
goods where the shopper takes both units; on cheap staples BOGO is often a loss leader instead.)
...
5. What does the shopper feel in daily life standing in the aisle?
6. What can be shown on screen to make the contradiction obvious if paused?

## Source Map

| Source | Type | Publisher / Creator | URL | What it supports | Confidence | Use / Do not copy |
|---|---|---|---|---|---|---|
| "Buy one, get one free" (encyclopedia entry) | Fact / mechanism | Wikipedia | https://en.wikipedia.org/wiki/Buy_one,_get_one_free | Core mechanism: shoppers value the 1st unit more than the 2nd, so vs half-price they'd buy one, but BOGO gets full price for the first + "free" second (attrib. economist Alex Tabarrok); BOGOF/BOGO acronym; invented by Josiah Wedgwood (18th c.); criticisms: food waste + "deceptively encourage customers to buy more than they otherwise would" | High | Use as mechanism + history. Do not copy phrasing |
| The Cost of Zero Cost (chapter 3) | Fact / psychology | Dan Ariely, *Predictably Irrational* (via Wikipedia) | https://en.wikipedia.org/wiki/Predictably_Irrational | The power of "FREE": "when something is FREE! we forget the downside… we perceive what is being offered as immensely more valuable than it really is" | High (concept); Med (exact experiment numbers) | Use the FREE-forgets-the-downside idea. Do not reproduce the book's exact examples as our script |
...
- **Arithmetic fact:** the per-item price to the shopper is identical ($5), so the deals "look the same."
- **Inference (stated conditions):** when the item's cost is under half its price (high margin) *and* the shopper takes both units, BOGO yields ~2× the store's gross profit of an equivalent-looking 50%-off, and collects more total cash ($10 vs $5).
- **Shopper side (fact):** with 50% off you spend $5 for the one thing you wanted; with BOGO you spend $10 and carry home a second unit you may not have needed. If you only wanted one, 50% off is the cheaper choice for *you*.
- **Variant (arithmetic):** "Buy 1 Get 1 *50% off*" is only a **25%** effective discount, dressed up as "free."

## Why It Keeps Happening

- **You value the second unit less than the first** (Wikipedia/Tabarrok). Half-price tempts you to buy only one; BOGO charges full price for the first and slips you the "free" second.
...
|---|---|---|---|
| $10 item, $4 cost: 50% off → $1 profit vs BOGO → $2 profit | The exact "double profit" mechanism | Arithmetic on stated assumptions | Side-by-side tag + receipt + profit meter |
| "Buy 1 Get 1 50% off" = 25% real discount | Hidden weaker variant | Arithmetic | Cross out "FREE," write "25% off" in red |
| Short-shelf-life food (yogurt, bread) BOGO | Encourages overbuying → food waste | Wikipedia BOGO criticism | Fridge with an expired second item, sad |
| Milk/eggs BOGO as loss leader | When the store *loses* on the deal to win the basket | Wikipedia loss leader | Cheap staple → arrow → full profitable cart |
| Josiah Wedgwood, 18th-century pottery | BOGO is ~250 years old, not a modern trick | Wikipedia BOGO history | Old-timey shop card "two for one" |
...
### Thumbnail Tension
- Two near-identical tags side by side, one circled red; betrayed/grinning WIT between them; 1–3 words: "SAME?" or "FREE?".
- Do NOT put the full title text in the thumbnail (channel rule).

### WIT Emotions
- Confident math face → suspicious squint → hypnotized by FREE → betrayed → dry "I knew it" → calm/wiser.
- Giant WIT holding two of the same product, grinning, while register rings 2× behind him (dramatic irony).

### Color And Contrast
- Retail yellow/red sale palette for tags and "FREE!" sticker; clean neutral for the math reveal.
- High contrast at mobile size; handwritten cream label reserved for the truthful asides/footnotes.
...
- Per item, "50% off (buy 1)" and "Buy 1 Get 1 Free" can cost the shopper the same amount. (Arithmetic.)
- With 50% off you buy one and spend less; with BOGO you typically buy two and spend more total. (Arithmetic + Vox/Wikipedia.)
- People value the second identical unit less than the first, which is why BOGO outperforms half-price for the seller. (Wikipedia/Tabarrok.)
- "Free" carries an outsized emotional pull that makes people discount the downside. (Ariely.)
- "Buy 1 Get 1 50% off" is a 25% effective discount. (Arithmetic.)
- BOGO is an old technique (18th century, Josiah Wedgwood). (Wikipedia.)
- Two-for-one offers on short-shelf-life food are linked to more food waste and to buying more than intended. (Wikipedia.)
...
- Citing the Ariely experiment's exact numbers without verifying the primary paper.
...
Strong enough to move into script. The contradiction, the worked math, the four "why it works"
mechanisms (value-of-second-unit, FREE effect, anchoring, volume), the honesty caveat (loss
leader), and the visual motif (two tags + profit meter + FREE sticker) are all grounded. Keep the
script on the $10/$4 abstract example to stay safe; route any real-world margin number through the
Open Questions before using it. Lead with the contradiction, end with "free cuts your judgment,"
and keep the tone curious, not accusatory.
