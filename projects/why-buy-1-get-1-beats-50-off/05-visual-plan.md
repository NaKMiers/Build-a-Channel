...
- Asset reuse notes: the two-sign device and WIT poses recur across sections; S1 magic-stage is the hook bookend

## Stale / Regeneration Notes

- Only Section 1 is planned. Sections 2–7 are `not planned`.
- If `02-script.md` or a section's voiceover changes, that section's plan and downstream render become stale.
