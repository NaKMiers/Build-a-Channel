...
- Use [Visual Plan](C:\ME\THINGS\Build a Channel\.agents\skills\visual-plan\SKILL.md) when the user asks for visual plan, section scene plan, real-life visual references, generated visual references, HyperFrames build guidance, or step 4 of the main video workflow.
- Use [Render](C:\ME\THINGS\Build a Channel\.agents\skills\render\SKILL.md) when the user asks for render, HyperFrames build, create video from visual plan, section preview, localhost preview, section MP4 render, or step 5 of the main video workflow.
