...
- `common/script-tone-system.md`
- `common/script-templates/deadpan-explainer-template.md`
- `common/script-templates/section-joke-builder.md`
- `common/script-templates/learner-friendly-script-checklist.md`

Forbidden outputs:

- no edits to `video-projects/<slug>/02-script.md`
...
```text
Scope: CHANNEL_WIDE.
Read docs/channel-improvement-plans/02-tone-and-script-plan.md.
Create or update the channel-wide script tone system.
Allowed outputs are common/script-tone-system.md and common/script-templates/.
