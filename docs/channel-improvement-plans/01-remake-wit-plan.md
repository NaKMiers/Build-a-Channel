...
- `common/assets/wit/README.md`
- `common/assets/wit/poses/comedy-core/`
- `common/assets/wit/poses/comedy-core/contact-sheet.png`
...
8. Add approved poses to `common/assets/wit/poses/`.
...
```text
Scope: CHANNEL_WIDE.
Read docs/channel-improvement-plans/01-remake-wit-plan.md.
Audit the current WIT assets under common/assets/wit.
Create or update the channel-wide WIT system only.
Allowed outputs are docs/branding and common/assets/wit.
