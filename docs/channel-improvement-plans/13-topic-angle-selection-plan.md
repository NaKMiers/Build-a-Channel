...
- `common/topic-angle-selection-system.md`
- `common/topic-angle-scorecard.md`
- `docs/topic-angle-scorecards/README.md`
...
```text
Scope: CHANNEL_WIDE.
Read docs/channel-improvement-plans/13-topic-angle-selection-plan.md.
Create or update the channel-wide topic angle selection system.
Allowed outputs are common/topic-angle-selection-system.md, common/topic-angle-scorecard.md, and docs/topic-angle-scorecards/.
