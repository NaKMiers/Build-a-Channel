...
- `common/assets/comedy/README.md`
- `common/assets/comedy/asset-inventory.md`
- `common/assets/comedy/source-note-template.md`
- `common/assets/comedy/contact-sheets/`
...
1. Audit existing assets under `common/assets/`.
2. Identify reusable objects already present.
3. Create the `common/assets/comedy/` folder.
...
```text
Scope: CHANNEL_WIDE.
Read docs/channel-improvement-plans/11-comedy-asset-library-plan.md.
Audit common/assets and propose the first comedy asset library pass.
