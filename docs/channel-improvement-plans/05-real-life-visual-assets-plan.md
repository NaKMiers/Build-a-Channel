...
- `common/real-life-visual-asset-system.md`
...
```text
Scope: CHANNEL_WIDE.
Read docs/channel-improvement-plans/05-real-life-visual-assets-plan.md.
Create or update the channel-wide real-life visual asset system.
Allowed outputs are common/real-life-visual-asset-system.md and reusable common/assets folders.
