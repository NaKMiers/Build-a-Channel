...
- [Topic Angle Selection System](C:\ME\THINGS\Build a Channel\common\topic-angle-selection-system.md)
- [Topic Angle Scorecard](C:\ME\THINGS\Build a Channel\common\topic-angle-scorecard.md)
...
```text
video-projects/<slug>/00-idea.md
```
