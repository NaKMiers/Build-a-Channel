...
- `.agents/_shared/scene-grammar-system.md`
- `.agents/_shared/visual-humor-patterns.md`
- `.agents/_shared/hyperframes/board-grammar.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/06-scene-grammar-and-visual-humor-plan.md.
Create or update the channel-wide scene grammar and visual humor system.
Allowed outputs are .agents/_shared/scene-grammar-system.md, .agents/_shared/visual-humor-patterns.md, and .agents/_shared/hyperframes/.
