...
- `.agents/_shared/thumbnail-packaging-system.md`
- `.agents/_shared/thumbnail-templates/`
- `.agents/_shared/packaging-scorecard.md`
- `.agents/_shared/channel/branding/thumbnail-visual-rules.md`

Forbidden outputs:

- no edits to `projects/<slug>/03-packaging.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/03-thumbnail-packaging-plan.md.
Create or update the channel-wide thumbnail and packaging system.
Allowed outputs are .agents/_shared/thumbnail-packaging-system.md, .agents/_shared/thumbnail-templates/, and .agents/_shared/channel/branding/.
