...
- `.agents/_shared/music-and-sound-system.md`
- `.agents/_shared/sound-effects-library/README.md`
- `.agents/_shared/audio-mixing-checklist.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/08-music-and-sound-plan.md.
Create or update the channel-wide music and sound system.
Allowed outputs are .agents/_shared/music-and-sound-system.md, .agents/_shared/sound-effects-library/, and .agents/_shared/audio-mixing-checklist.md.
