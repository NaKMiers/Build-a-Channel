...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/10-reference-board-and-research-plan.md.
Create or update the channel-wide reference-board system.
Allowed outputs are .agents/_shared/reference-board-system.md and .agents/_shared/reference-boards/.
