...
- `.agents/_shared/hook-system.md`
- `.agents/_shared/hook-templates/first-10-seconds-board-template.md`
- `.agents/_shared/hook-templates/hook-scorecard.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/04-first-10-seconds-hook-plan.md.
Create or update the channel-wide first 10 seconds hook system.
Allowed outputs are .agents/_shared/hook-system.md and .agents/_shared/hook-templates/.
