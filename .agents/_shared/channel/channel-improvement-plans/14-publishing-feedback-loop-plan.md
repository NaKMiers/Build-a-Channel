...
- `.agents/_shared/publishing-feedback-loop.md`
- `.agents/_shared/post-upload-review-template.md`
- `.agents/_shared/channel-learning-rules.md`
...
Only write channel-level lessons into `.agents/_shared/channel/learning-log.md` if they are reusable.
...
Do not rewrite `.agents/_shared/channel/channel-foundation.md` unless the user explicitly confirms a core change.
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/14-publishing-feedback-loop-plan.md.
Create or update the channel-wide publishing feedback loop.
Allowed outputs are .agents/_shared/publishing-feedback-loop.md, .agents/_shared/post-upload-review-template.md, and .agents/_shared/channel-learning-rules.md.
