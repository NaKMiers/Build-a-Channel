...
- `.agents/_shared/voice/narration-system.md`
- `.agents/_shared/voice/script-markup-guide.md`
- `.agents/_shared/voice/voice-test-protocol.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/07-voice-and-narration-plan.md.
Create or update the channel-wide narration system.
Allowed outputs are .agents/_shared/voice/narration-system.md, .agents/_shared/voice/script-markup-guide.md, and .agents/_shared/voice/voice-test-protocol.md.
