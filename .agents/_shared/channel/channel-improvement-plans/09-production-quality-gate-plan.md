...
- `.agents/_shared/production-quality-gate.md`
- `.agents/_shared/pre-production-checklist.md`
- `.agents/_shared/final-review-checklist.md`
...
```text
Scope: CHANNEL_WIDE.
Read .agents/_shared/channel/channel-improvement-plans/09-production-quality-gate-plan.md.
Create or update the channel-wide production quality gate.
Allowed outputs are .agents/_shared/production-quality-gate.md, .agents/_shared/pre-production-checklist.md, and .agents/_shared/final-review-checklist.md.
