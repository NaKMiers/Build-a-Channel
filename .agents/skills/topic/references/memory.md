...
| The Economics of Free-to-Play Games | planned |
...
- A HumanPrice topic needs a transaction, an incentive map, a behavioral engine, and a
  consequence that reaches beyond the visible price.
- Avoid topics that can only support a list of facts. The mechanism must escalate.
