...
- BASES: one vivid object photo per scene with a planned DARK dramatic grade (`brightness ~0.42–0.55`, raised saturation/contrast) + heavy scrim + glow. Reusing money/coins/cash/padlock/curtain bases across sections (with DISTINCT grades) is fine and on-brand. Never plan a plain/literal-but-flat base (bare wood, objects-on-white, a dim/obscure antique) — those read as "too simple."
